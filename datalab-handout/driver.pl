...
#
# egm -- set the weight for performance to 3
if ($USE_BTEST) {
...
## egm -- Hardcoded the total_c_rating for simplicity
# TODO: add a function to automatically scale and compute
#       similar to btest (search egm in btest.c)
$total_c_rating = 35;
